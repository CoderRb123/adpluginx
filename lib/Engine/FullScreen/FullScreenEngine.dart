    ...
    switch (screenWiseModel!.localClick![index]) {
      ...
      case 10:
        if (screenWiseModel!.overRideTimer!) {
          timer = Timer(Duration(seconds: screenWiseModel!.overRideTimerValue!),
              () {
            _failed(10, route: route);
          });
        }
        dog.i("Case Yodo Inter");
      ...
      case 11:
        if (screenWiseModel!.overRideTimer!) {
          timer = Timer(Duration(seconds: screenWiseModel!.overRideTimerValue!),
              () {
            _failed(11, route: route);
          });
        }
        dog.i("Case Yodo Reward");
      ...
      case 12:
        if (screenWiseModel!.overRideTimer!) {
          timer = Timer(Duration(seconds: screenWiseModel!.overRideTimerValue!),
              () {
            _failed(12, route: route);
          });
        }
        dog.i("Case Yodo Reward Inter");
